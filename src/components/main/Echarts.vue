  ...
  <el-card class="box-card">
    <template #header>
      <div class="card-header">
        <span style="font-weight: 700;">开箱即用图表库</span>
      </div>
    </template>
 <div class="gradientColor up"></div>
 <div class="bing up"></div>

 <div class="xZhu down"></div>
 <div class="bigData down"></div>
...
onMounted(()=>{
//gradientCOlor
 document.querySelector(".gradientColor")?.removeAttribute("_echarts_instance_");
var chartDom = document.querySelector('.gradientColor') as HTMLElement
var chart1 = echarts.init(chartDom);
var option;

// prettier-ignore
let dataAxis = ['1班', '2班', '3班', '4班', '5班', '6班', '7班', '8班', '9班', '10班', '11班', '12班', '人1', '人2']
// prettier-ignore
let data = [30,31,30,32,31,40,31,32,34,45,34,36,32,38];
let yMax = 50;
let dataShadow = [];
  ...
  series: [
    {
      ...
      itemStyle: {
        color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          { offset: 0, color: '#e7f2c8' },
          { offset: 0.5, color: '#bec4d2' },
          { offset: 1, color: '#a1a8d6' }
        ])
      },
      emphasis: {
        itemStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            { offset: 0, color: '#fcfcf1' },
            { offset: 0.7, color: '#e5e4c6' },
            { offset: 1, color: '#9bd2cc' }
          ])
        }
      },
      data: data
...
//xZhu
 document.querySelector(".xZhu")?.removeAttribute("_echarts_instance_");

var chartDom2 = document.querySelector('.xZhu') as HTMLElement
...
option = {
    title: {
    text: '自定义 暖色调 数据图表',
    subtext: 'Feature Sample: Different Color, Colorful, Data Clearly'
  },
  dataset: {
    source: [
...
//bin
 document.querySelector(".bing")?.removeAttribute("_echarts_instance_");

var app = {};

var chartDom3 = document.querySelector('.bing') as HTMLElement
...
option3 = {
  title: {
    text: '饼图纹理',
    subtext: 'Feature Sample: Dream of Color'
  },
  tooltip: {},
  series: [
    {
...
//bigData
 document.querySelector(".bigData")?.removeAttribute("_echarts_instance_");

var chartDom4 = document.querySelector('.bigData') as HTMLElement
...
option = {
  title: {
    text: '自定义 堆叠 图表',
    subtext: 'Feature Sample: Clear Data Show'
  },
  tooltip: {
    trigger: 'axis',
    axisPointer: {
